...
for (let i of products.data) {
    ...
    document.getElementById("product").appendChild(product_info)

    let image = document.createElement("img")
    image.setAttribute("src", i.image)
    product_info.appendChild(image)
    ...
    product_text.appendChild(name)

    let price = document.createElement("p")
    price.innerText = "Price: " + i.price + "$"
    product_text.appendChild(price)

    let button = document.createElement("a")
    button.classList.add("button")
    button.setAttribute("href", "submit.html")
